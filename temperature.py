...
var = ctk.IntVar()
radio_celsius = ctk.CTkButton(window, text="Celsius to Fahrenheit", command=CelciusToFahrenheit)
radio_celsius.pack(pady=10)

radio_fahrenheit = ctk.CTkButton(window, text="Fahrenheit to Celsius", command=FahrenheitToCelcius)
radio_fahrenheit.pack(pady=10)
